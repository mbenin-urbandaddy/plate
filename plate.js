...
require.define("/lib/tags/load.js",function(require,module,exports,__dirname,__filename,process){module.exports = LoadNode

var Promise = require('../promise')

function LoadNode(target_var, loader) {
  this.target_var = target_var
  this.loader = loader
}
